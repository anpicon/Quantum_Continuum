...
public:
    ...
    vec3x coeff2D;
    vec4x coeff3D;
    FittedData(vec3x&,vec1d&,vec1d&);
    complexd operator()(double x, double y, double z);
    string get_size();
};//FittedData

FittedData::FittedData(vec3x& Data,vec1d& spacing,vec1d& xmin): _spacing(spacing), _xmin(xmin)
{
    NX=Data.size();
    NY=Data[0].size();
    NZ=Data[0][0].size();
...
complexd FittedData::operator()(double x, double y, double z)
{
    ...
    */
    if (SizeData=="3Ddata") {
        ...
        complexd p0=(coeff3D[xi-1][yi][zi][0] + coeff3D[xi-1][yi][zi][1] * dz + coeff3D[xi-1][yi][zi][2] * z2 + coeff3D[xi-1][yi][zi][3] * z3) +
        ...
        complexd p1=(coeff3D[xi][yi][zi][0] + coeff3D[xi][yi][zi][1] * dz + coeff3D[xi][yi][zi][2] * z2 + coeff3D[xi][yi][zi][3] * z3) +
        ...
        complexd p2=(coeff3D[xi+1][yi][zi][0] + coeff3D[xi+1][yi][zi][1] * dz + coeff3D[xi+1][yi][zi][2] * z2 + coeff3D[xi+1][yi][zi][3] * z3) +
        (coeff3D[xi+1][yi][zi][4] + coeff3D[xi+1][yi][zi][5] * dz + coeff3D[xi+1][yi][zi][6] * z2 + coeff3D[xi+1][yi][zi][7] * z3) * dy +
        (coeff3D[xi+1][yi][zi][8] + coeff3D[xi+1][yi][zi][9] * dz + coeff3D[xi+1][yi][zi][10] * z2 + coeff3D[xi+1][yi][zi][11] * z3) * y2 +
        (coeff3D[xi+1][yi][zi][12] + coeff3D[xi+1][yi][zi][13] * dz + coeff3D[xi+1][yi][zi][14] * z2 + coeff3D[xi+1][yi][zi][15] * z3) * y3;
        
        complexd p3=(coeff3D[xi+2][yi][zi][0] + coeff3D[xi+2][yi][zi][1] * dz + coeff3D[xi+2][yi][zi][2] * z2 + coeff3D[xi+2][yi][zi][3] * z3) +
...
public:
    ...
    vec3d coeff2D;
    vec4d coeff3D;
    FittedDataREAL(vec3d&,vec1d&,vec1d&);
    double operator()(double x, double y, double z);
    string get_size();
};//FittedData

FittedDataREAL::FittedDataREAL(vec3d& Data,vec1d& spacing,vec1d& xmin): _spacing(spacing), _xmin(xmin)
{
    NX=Data.size();
    NY=Data[0].size();
    NZ=Data[0][0].size();
    ...
    if(NX==1 && NY==1) {
        ...
        if (iPrint=="all") printf("Fitting 2D data...\n");
        coeff2D.resize(NY,vec2d(NZ,vec1d(16,0.)));
        SizeData="2Ddata";
        if(_spacing[1] <= 0 && _spacing[2] <= 0) {
            printf("Bad datacube grid spacing.\n");
            exit(1);
        ...
        if (iPrint=="all") printf("Fitting 3D data...\n");
        coeff3D.resize(NX+3,vec3d(NY,vec2d(NZ,vec1d(16,0.))));
        SizeData="3Ddata";
        if(_spacing[0] <= 0) {
            printf("Bad datacube grid spacing.\n");
            exit(1);
    ...
    //multivector to impose the boundary conditions in the boundary points calculations
    vec3d _data(NX+3,vec2d(NY+3,vec1d(NZ+3,0.)));
    for (int ix=0; ix<NX+3; ix++)
    {
        int ixx=(NX > 1 ? ix-1 : ix);
        ixx=(ixx >= 0 ? ixx % NX : NX + ixx % NX);
...
double FittedDataREAL::operator()(double x, double y, double z)
{
    // Map x,y,z to a point dx,dy,dz in the cube [0,NX) x [0,NY) x [0,NZ)
    double dx(std::fmod((x-_xmin[0])/_spacing[0],NX)), dy(std::fmod((y-_xmin[1])/_spacing[1],NY)), dz(std::fmod((z-_xmin[2])/_spacing[2],NZ));
    if(dx < 0) dx += NX;
    ...
    if (SizeData=="3Ddata") {
        ...
        double p0=(coeff3D[xi-1][yi][zi][0] + coeff3D[xi-1][yi][zi][1] * dz + coeff3D[xi-1][yi][zi][2] * z2 + coeff3D[xi-1][yi][zi][3] * z3) +
        (coeff3D[xi-1][yi][zi][4] + coeff3D[xi-1][yi][zi][5] * dz + coeff3D[xi-1][yi][zi][6] * z2 + coeff3D[xi-1][yi][zi][7] * z3) * dy +
        (coeff3D[xi-1][yi][zi][8] + coeff3D[xi-1][yi][zi][9] * dz + coeff3D[xi-1][yi][zi][10] * z2 + coeff3D[xi-1][yi][zi][11] * z3) * y2 +
        (coeff3D[xi-1][yi][zi][12] + coeff3D[xi-1][yi][zi][13] * dz + coeff3D[xi-1][yi][zi][14] * z2 + coeff3D[xi-1][yi][zi][15] * z3) * y3;
        
        double p1=(coeff3D[xi][yi][zi][0] + coeff3D[xi][yi][zi][1] * dz + coeff3D[xi][yi][zi][2] * z2 + coeff3D[xi][yi][zi][3] * z3) +
        (coeff3D[xi][yi][zi][4] + coeff3D[xi][yi][zi][5] * dz + coeff3D[xi][yi][zi][6] * z2 + coeff3D[xi][yi][zi][7] * z3) * dy +
        (coeff3D[xi][yi][zi][8] + coeff3D[xi][yi][zi][9] * dz + coeff3D[xi][yi][zi][10] * z2 + coeff3D[xi][yi][zi][11] * z3) * y2 +
        (coeff3D[xi][yi][zi][12] + coeff3D[xi][yi][zi][13] * dz + coeff3D[xi][yi][zi][14] * z2 + coeff3D[xi][yi][zi][15] * z3) * y3;
        
        double p2=(coeff3D[xi+1][yi][zi][0] + coeff3D[xi+1][yi][zi][1] * dz + coeff3D[xi+1][yi][zi][2] * z2 + coeff3D[xi+1][yi][zi][3] * z3) +
        (coeff3D[xi+1][yi][zi][4] + coeff3D[xi+1][yi][zi][5] * dz + coeff3D[xi+1][yi][zi][6] * z2 + coeff3D[xi+1][yi][zi][7] * z3) * dy +
        (coeff3D[xi+1][yi][zi][8] + coeff3D[xi+1][yi][zi][9] * dz + coeff3D[xi+1][yi][zi][10] * z2 + coeff3D[xi+1][yi][zi][11] * z3) * y2 +
        (coeff3D[xi+1][yi][zi][12] + coeff3D[xi+1][yi][zi][13] * dz + coeff3D[xi+1][yi][zi][14] * z2 + coeff3D[xi+1][yi][zi][15] * z3) * y3;
        
        double p3=(coeff3D[xi+2][yi][zi][0] + coeff3D[xi+2][yi][zi][1] * dz + coeff3D[xi+2][yi][zi][2] * z2 + coeff3D[xi+2][yi][zi][3] * z3) +
        (coeff3D[xi+2][yi][zi][4] + coeff3D[xi+2][yi][zi][5] * dz + coeff3D[xi+2][yi][zi][6] * z2 + coeff3D[xi+2][yi][zi][7] * z3) * dy +
        (coeff3D[xi+2][yi][zi][8] + coeff3D[xi+2][yi][zi][9] * dz + coeff3D[xi+2][yi][zi][10] * z2 + coeff3D[xi+2][yi][zi][11] * z3) * y2 +
        (coeff3D[xi+2][yi][zi][12] + coeff3D[xi+2][yi][zi][13] * dz + coeff3D[xi+2][yi][zi][14] * z2 + coeff3D[xi+2][yi][zi][15] * z3) * y3;
...
string FittedDataREAL::get_size()
{
    return SizeData;
}
